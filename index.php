<?php 
$name = 'Александр Пашкин';
$profession = 'Менеджер';
$city = 'Санкт-Петербург';
$email = 'alepas13@gmail.com';
$tel = 89110187938;
 
$skills = [
	['name' => 'Продажи', 'percent' => 95],
	['name' => 'Работа с возражениями', 'percent' => 80],
	['name' => 'Работа в CRM', 'percent' => 70],
	['name' => 'Сопровождение клиентов', 'percent' => 90],
];
 $works = [
    [
    "name" => "Менеджер",
    "dataStart" =>"Ноябрь 2022",
    "dataEnd" => "Текущее время",
    "description"=> "Работать с входящим потоком клиентов, а также привлекать новых клиентов",
 ],
 ["name" => "Специалист первой линии поддержки",
 "dataStart" =>"Май 2021",
 "dataEnd" => "Ноябрь 2022",
 "description"=> "Работа с письменными обращениями клиентов",
],
["name" => "SMM-специалист",
 "dataStart" =>"Август 2019",
 "dataEnd" => "Май 2021",
 "description"=> "Представлять компанию в социальных сетях, отвечать за репутацию компании в интернете",
],
];
